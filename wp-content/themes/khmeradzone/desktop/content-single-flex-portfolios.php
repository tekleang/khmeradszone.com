        ...
        <div class="container-fluid sub-banner padding-0">
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                <div class="item">
                    ...
                    <img src="<?php _e(get_field('banner_portfolios','option')); ?>" alt="Los Angeles">
                    <div class="carousel-caption">
                        <div class="box-text-button">
                            ...
                            <ul class="click-home last-border">
                                ...
                                <li><a href="<?php _e(get_permalink(12)); ?>">portfolios</a></li>
                                <li class="active"><a><?php _e(shortenText(get_the_title(),100)); ?></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
